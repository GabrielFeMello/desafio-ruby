...
class RepresentativesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create representative" do
    assert_difference('Representative.count') do
      post representatives_url, params: { representative: { name: @representative.name, store_id: @representative.store_id } }
    end
  ...
  test "should update representative" do
    patch representative_url(@representative), params: { representative: { name: @representative.name, store_id: @representative.store_id } }
